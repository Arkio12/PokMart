...
-- Create Pokemon table with correct column names
...
-- Insert sample Pokemon data with correct column name
INSERT INTO pokemon (id, name, image, price, description, "inStock", featured, hp, attack, defense, speed) VALUES
